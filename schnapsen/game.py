...
class GamePlayEngine:
    ...
    def play_game(self, bot1: Bot, bot2: Bot, rng: Random) -> tuple[PlayerPerspective, int, PlayerPerspective, Bot]:
        """
        ...
        winner_state, points, loser_state, winBot = self.play_game_from_state(game_state=game_state, leader_move=None)
        return winner_state, points, loser_state, winBot
    ...
    def play_game_from_state_with_new_bots(self, game_state: GameState, new_leader: Bot, new_follower: Bot, leader_move: Optional[Move]) -> tuple[PlayerPerspective, int, PlayerPerspective, Bot]:
        """
    ...
    def play_game_from_state(self, game_state: GameState, leader_move: Optional[Move]) -> tuple[PlayerPerspective, int, LoserPerspective, Bot]:
        """
        ...
        return winner_state, points, loser_state, winner.implementation
